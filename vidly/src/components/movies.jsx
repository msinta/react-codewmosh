...
class Movies extends Component {
  ...
  render() {
    const { pageSize, currentPage, newMovies: allMovies } = this.state;
    if (this.state.newMovies.length === 0) return <p className="m-3"> There are no Movies in the database!</p>;
